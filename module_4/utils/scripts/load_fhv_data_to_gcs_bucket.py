...
import time
import os
from utils.functions.general_functions import get_project_root

# Change this to your bucket name
BUCKET_NAME = "dezoomcamp_homework_m4_2026_santiago_villaverde"

# If you authenticated through the GCP SDK you can comment out these two lines
CREDENTIALS_FILE = get_project_root() / "utils" / "keys" / "data_load_sa_key.json"
...
def download_file(month):
    ...
    url = f"{BASE_URL}".format(month=month)
